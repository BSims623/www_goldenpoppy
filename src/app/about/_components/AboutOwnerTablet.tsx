...
export default function AboutOwnerTablet() {
  return (
    <section className="mx-auto hidden w-full max-w-5xl pt-10 md:block lg:hidden">
      ...
      <div className="grid grid-cols-[auto_300px] gap-2">
        <div>
